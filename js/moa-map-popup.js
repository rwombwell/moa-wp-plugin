...
function StaticMapCreate( MapDivTarget, callbackFldName ) {
	...
	////////////////////////////////////////////
	// GET LAT/LONG CALLBACK FIELD - and WORK OUT EDIT MODE FROM TAGE="INPUT"
	...
	/////////////////////////////////////////////
	// GET MAP CENTER COORDS FROM LANT/LONG - make the map centre the long/lat in the callback fld, if empty then set the centre to global default
	...
	////////////////////////////////////////////////
	// CREATE MAP OBJECT - create a Leaflet map object with the centre set above & setLeaflet tile layer to OpenStreetMaps
	...
	///////////////////////////////////////
	// SET PIN MARKER, DIFFERENT FOR EDITING AND VIEWING -  ie when called from  Editing or Viewing  Profile o
	if ( editMode ) {			

		///////////////////////////////////
		// EDITING YES - ADD A PIN MARKER AND SET IT TO BE DRAGGABLE, (ie in EDIT  Profile mode)
		...
		/////////////////////////////////////
		// Default Leaflet map click event is to close popup, so this event handler fixes that
		...
		///////////////////////////////////
		// EDITING NO - ADD A NON-DRAGGABLE PIN MARKER, (ie in VIEW Profile mode)
	...
	///////////////////////////////////
	// ADD MARKER TO MAP - Set the same marker popup box for both edit and view mode 
	marker
...
function CreateMarkerIcon( color ) {
    var icon = new L.Icon({
        ...
        iconSize: [25, 41],
		iconAnchor: [12, 41],		// offset of icon tip from icon top left, relates to icon size - actually sets a margin-left and margin-top on the icon
		...
		className: `marker-icon-${color}`	// identifying an icon by color seems only way to change cursor style (by using CSS)
	});
    return icon;
}
/********************************************************
